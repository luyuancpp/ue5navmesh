...
{
	int64_t idx;		///< The index of the neighbor in the crowd.
...
public:
	...
	inline auto getNumActiveAgents() const { return m_numActiveAgents; }

	inline auto getAgentIndex(const dtCrowdAgent* agent) const  { return agent - m_agents; }
