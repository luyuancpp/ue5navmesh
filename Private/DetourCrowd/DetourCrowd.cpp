...
void dtCrowd::updateStepOffMeshAnim(const dtReal dt, dtCrowdAgentDebugInfo*)
{
	...
	{
		dtCrowdAgent* ag = m_activeAgents[i];
		auto agentIndex = getAgentIndex(ag);
